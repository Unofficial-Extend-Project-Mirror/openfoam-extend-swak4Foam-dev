...
vexp:   vector                                    { $$ = $1; }
        ...
        | exp '*' vexp 		                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 * *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '*' exp 		                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 * *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | texp '&' vexp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '&' texp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | yexp '&' vexp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '&' yexp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | hexp '&' vexp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '&' hexp 	                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 & *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '/' exp 		                  { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 / *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '^' vexp 		          { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 ^ *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | vexp '-' vexp 		          { sameSize($1,$3); $$ = new Foam::volVectorField(*$1 - *$3); delete $1; delete $3;   driver.setCalculatedPatches(*$$); }
        | '-' vexp %prec TOKEN_NEG                { $$ = new Foam::volVectorField(-*$2); delete $2;   driver.setCalculatedPatches(*$$); }
        | '(' vexp ')'		                  { $$ = $2; }
        | lexp '?' vexp ':' vexp                  { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::volVectorField>(Foam::vector())); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$); }
        | TOKEN_position '(' ')'                  { $$ = driver.makePositionField(); }
        | TOKEN_laplacian '(' fsexp ',' vexp ')'  { $$ = new Foam::volVectorField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_faceAverage '(' fvexp ')'         { $$ = new Foam::volVectorField(Foam::fvc::average(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_integrate '(' fvexp ')'           { $$ = new Foam::volVectorField(Foam::fvc::surfaceIntegrate(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_surfSum '(' fvexp ')'             { $$ = new Foam::volVectorField(Foam::fvc::surfaceSum(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_interpolateToCell '(' pvexp ')'              { $$ = driver.pointToCellInterpolate(*$3).ptr(); delete $3;   driver.setCalculatedPatches(*$$); }
        ...
        | TOKEN_grad '(' exp ')'                  { $$ = new Foam::volVectorField(Foam::fvc::grad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_reconstruct '(' fsexp ')'         { $$ = new Foam::volVectorField(Foam::fvc::reconstruct(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_curl '(' vexp ')'                 { $$ = new Foam::volVectorField(Foam::fvc::curl(*$3)); delete $3; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | TOKEN_div '(' fsexp ',' vexp ')'        { $$ = new Foam::volVectorField(Foam::fvc::div(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$); }
        | evaluateVectorFunction restOfFunction
        | TOKEN_VID                               { $$=driver.getField<Foam::volVectorField>(*$1); delete $1; }
        | TOKEN_ddt '(' TOKEN_VID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::volVectorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$);  delete $3; }
        | TOKEN_d2dt2 '(' TOKEN_VID ')'		   { $$ = Foam::fvc::d2dt2( driver.getOrReadField<Foam::volVectorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);   driver.setCalculatedPatches(*$$);  delete $3; }
        | TOKEN_oldTime '(' TOKEN_VID ')'		   { $$ = new Foam::volVectorField( driver.getOrReadField<Foam::volVectorField>(*$3,true,true)->oldTime());   driver.setCalculatedPatches(*$$);  delete $3; }
;
...
// doesn't work directly        | TOKEN_tr '(' fhexp ')'            {$$ = new Foam::surfaceScalarField(Foam::tr(*$3)); delete $3; }
        ...
        | TOKEN_FSID                        { $$ = driver.getField<Foam::surfaceScalarField>(*$1);  delete $1; }
        | evaluateFaceScalarFunction restOfFunction
//        | TOKEN_ddt '(' TOKEN_FSID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::surfaceScalarField>(*$3,true,true)() ).ptr();  delete $3; } // no fvc::ddt for surface Fields
        | TOKEN_oldTime '(' TOKEN_FSID ')'		   { $$ = new Foam::surfaceScalarField( driver.getOrReadField<Foam::surfaceScalarField>(*$3,true,true)->oldTime());  delete $3; }
        | TOKEN_meshPhi '(' vexp ')'      { $$ = Foam::fvc::meshPhi(*$3).ptr(); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_meshPhi '(' exp ',' vexp ')'      { $$ = Foam::fvc::meshPhi(*$3,*$5).ptr(); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
...
fvexp:  fvector                            { $$ = $1; }
        ...
        | TOKEN_snGrad '(' vexp ')'        { $$ = new Foam::surfaceVectorField(Foam::fvc::snGrad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_FVID                       { $$ = driver.getField<Foam::surfaceVectorField>(*$1);  delete $1; }
//        | TOKEN_ddt '(' TOKEN_FVID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::surfaceVectorField>(*$3,true,true)() ).ptr();  delete $3; }// no fvc::ddt for surface Fields
        | TOKEN_oldTime '(' TOKEN_FVID ')'		   { $$ = new Foam::surfaceVectorField( driver.getOrReadField<Foam::surfaceVectorField>(*$3,true,true)->oldTime());  delete $3; }
        | TOKEN_flux '(' fsexp ',' vexp ')'       { $$ = Foam::fvc::flux(*$3,*$5).ptr(); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
;
...
exp:    TOKEN_NUM                                  { $$ = driver.makeConstantField<Foam::volScalarField>($1); }
	...
	| '(' exp ')'		                   { $$ = $2; }
        ...
        | TOKEN_det '(' hexp ')'                   {
            ...
            delete $3;  driver.setCalculatedPatches(*$$); }
        | TOKEN_magSqrGradGrad '(' exp ')'         { $$ = new Foam::volScalarField(Foam::fvc::magSqrGradGrad(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_div '(' vexp ')'                   { $$ = new Foam::volScalarField(Foam::fvc::div(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_div '(' fsexp ')'                  { $$ = new Foam::volScalarField(Foam::fvc::div(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_div '(' fsexp ',' exp ')'          { $$ = new Foam::volScalarField(Foam::fvc::div(*$3,*$5)); delete $3; delete $5;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_laplacian '(' exp ')'              { $$ = new Foam::volScalarField(Foam::fvc::laplacian(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_laplacian '(' exp ',' exp ')'      { $$ = new Foam::volScalarField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_laplacian '(' fsexp ',' exp ')'    { $$ = new Foam::volScalarField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_faceAverage '(' fsexp ')'          { $$ = new Foam::volScalarField(Foam::fvc::average(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        | TOKEN_integrate '(' fsexp ')'            { $$ = new Foam::volScalarField(Foam::fvc::surfaceIntegrate(*$3)); delete $3;  driver.setCalculatedPatches(*$$); $$->dimensions().reset(Foam::dimless); }
        ...
        | lexp '?' exp ':' exp                     { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::volScalarField>(0.)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$);}
        ...
        | TOKEN_SID		                   { $$ = driver.getField<Foam::volScalarField>(*$1);  delete $1; }
        | evaluateScalarFunction restOfFunction
          { $$=$1; }
        | TOKEN_ddt '(' TOKEN_SID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::volScalarField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_d2dt2 '(' TOKEN_SID ')'		   { $$ = Foam::fvc::d2dt2( driver.getOrReadField<Foam::volScalarField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_oldTime '(' TOKEN_SID ')'	   { $$ = new Foam::volScalarField( driver.getOrReadField<Foam::volScalarField>(*$3,true,true)->oldTime());  delete $3; }
...
lexp: TOKEN_TRUE                       { $$ = driver.makeConstantField<Foam::volScalarField>(1); }
    ...
    | TOKEN_set '(' TOKEN_SETID ')'    {
        $$ = driver.makeCellSetField(*$3);
        delete $3;
      }
    | TOKEN_zone '(' TOKEN_ZONEID ')'  {
        $$ = driver.makeCellZoneField(*$3);
        delete $3;
      }
...
flexp: TOKEN_surf '(' TOKEN_TRUE ')'  { $$ = driver.makeConstantField<Foam::surfaceScalarField>(1); }
    ...
    | TOKEN_fset '(' TOKEN_FSETID ')'    {
        $$ = driver.makeFaceSetField(*$3);
        delete $3;
      }
    | TOKEN_fzone '(' TOKEN_FZONEID ')'  {
        $$ = driver.makeFaceZoneField(*$3);
        delete $3;
      }
    | TOKEN_onPatch '(' TOKEN_PATCHID ')'  {
        $$ = driver.makeOnPatchField(*$3);
        delete $3;
      }
...
texp:   tensor                  { $$ = $1; }
        ...
        | lexp '?' texp ':' texp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::volTensorField>(Foam::tensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$); }
        | TOKEN_laplacian '(' fsexp ',' texp ')'  { $$ = new Foam::volTensorField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_faceAverage '(' ftexp ')'         { $$ = new Foam::volTensorField(Foam::fvc::average(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_integrate '(' ftexp ')'           { $$ = new Foam::volTensorField(Foam::fvc::surfaceIntegrate(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_surfSum '(' ftexp ')'             { $$ = new Foam::volTensorField(Foam::fvc::surfaceSum(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_grad '(' vexp ')'                 { $$ = new Foam::volTensorField(Foam::fvc::grad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_div '(' fsexp ',' texp ')'        { $$ = new Foam::volTensorField(Foam::fvc::div(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | evaluateTensorFunction restOfFunction
        | TOKEN_TID                               { $$=driver.getField<Foam::volTensorField>(*$1);  delete $1; }
        | TOKEN_ddt '(' TOKEN_TID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::volTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_d2dt2 '(' TOKEN_TID ')'		   { $$ = Foam::fvc::d2dt2( driver.getOrReadField<Foam::volTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_oldTime '(' TOKEN_TID ')'		   { $$ = new Foam::volTensorField( driver.getOrReadField<Foam::volTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
//        | yexp '&' yexp 	   	          { sameSize($1,$3); $$ = new Foam::volSymmTensorField(*$1 & *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
        ...
        | TOKEN_sqr '(' vexp ')' 	           { $$ = new Foam::volSymmTensorField( Foam::sqr(*$3) ); delete $3;  driver.setCalculatedPatches(*$$); } 
        | lexp '?' yexp ':' yexp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::volSymmTensorField>(Foam::symmTensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$); }
        | TOKEN_laplacian '(' fsexp ',' yexp ')'  { $$ = new Foam::volSymmTensorField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_faceAverage '(' fyexp ')'         { $$ = new Foam::volSymmTensorField(Foam::fvc::average(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_integrate '(' fyexp ')'           { $$ = new Foam::volSymmTensorField(Foam::fvc::surfaceIntegrate(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_surfSum '(' fyexp ')'             { $$ = new Foam::volSymmTensorField(Foam::fvc::surfaceSum(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_div '(' fsexp ',' yexp ')'        { $$ = new Foam::volSymmTensorField(Foam::fvc::div(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | evaluateSymmTensorFunction restOfFunction
        | TOKEN_YID                               { $$=driver.getField<Foam::volSymmTensorField>(*$1);  delete $1; }
        | TOKEN_ddt '(' TOKEN_YID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::volSymmTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_d2dt2 '(' TOKEN_YID ')'		   { $$ = Foam::fvc::d2dt2( driver.getOrReadField<Foam::volSymmTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_oldTime '(' TOKEN_YID ')'	   { $$ = new Foam::volSymmTensorField( driver.getOrReadField<Foam::volSymmTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
hexp:   sphericalTensor                  { $$ = $1; }
        ...
        | TOKEN_inv '(' hexp ')' 	           {
            ...
            delete $3;  driver.setCalculatedPatches(*$$); }
        | lexp '?' hexp ':' hexp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::volSphericalTensorField>(Foam::sphericalTensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$);}
        | TOKEN_laplacian '(' fsexp ',' hexp ')'  { $$ = new Foam::volSphericalTensorField(Foam::fvc::laplacian(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_faceAverage '(' fhexp ')'         { $$ = new Foam::volSphericalTensorField(Foam::fvc::average(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_integrate '(' fhexp ')'           { $$ = new Foam::volSphericalTensorField(Foam::fvc::surfaceIntegrate(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        | TOKEN_surfSum '(' fhexp ')'             { $$ = new Foam::volSphericalTensorField(Foam::fvc::surfaceSum(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_div '(' fsexp ',' hexp ')'        { $$ = new Foam::volSphericalTensorField(Foam::fvc::div(*$3,*$5)); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
        | evaluateSphericalTensorFunction restOfFunction
        | TOKEN_HID                               { $$=driver.getField<Foam::volSphericalTensorField>(*$1);  delete $1; }
        | TOKEN_ddt '(' TOKEN_HID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::volSphericalTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_d2dt2 '(' TOKEN_HID ')'		   { $$ = Foam::fvc::d2dt2( driver.getOrReadField<Foam::volSphericalTensorField>(*$3,true,true)() ).ptr(); $$->dimensions().reset(Foam::dimless);  delete $3; }
        | TOKEN_oldTime '(' TOKEN_HID ')'	   { $$ = new Foam::volSphericalTensorField( driver.getOrReadField<Foam::volSphericalTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
ftexp:   ftensor                  { $$ = $1; }
        ...
        | flexp '?' ftexp ':' ftexp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::surfaceTensorField>(Foam::tensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$);}
        | TOKEN_snGrad '(' texp ')'           { $$ = new Foam::surfaceTensorField(Foam::fvc::snGrad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_FTID                               { $$=driver.getField<Foam::surfaceTensorField>(*$1);  delete $1; }
//        | TOKEN_ddt '(' TOKEN_FTID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::surfaceTensorField>(*$3,true,true)() ).ptr();  delete $3; } // no fvc::ddt for surface Fields
        | TOKEN_oldTime '(' TOKEN_FTID ')'	   { $$ = new Foam::surfaceTensorField( driver.getOrReadField<Foam::surfaceTensorField>(*$3,true,true)->oldTime());  delete $3; }
        | TOKEN_flux '(' fsexp ',' texp ')'       { $$ = Foam::fvc::flux(*$3,*$5).ptr(); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
;
...
//        | fyexp '&' fyexp 	   	          { sameSize($1,$3); $$ = new Foam::surfaceSymmTensorField(*$1 & *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
        ...
        | TOKEN_sqr '(' fvexp ')' 	           { $$ = new Foam::surfaceSymmTensorField( Foam::sqr(*$3) ); delete $3;  driver.setCalculatedPatches(*$$); } 
        | flexp '?' fyexp ':' fyexp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::surfaceSymmTensorField>(Foam::symmTensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$);}
        | TOKEN_snGrad '(' yexp ')'           { $$ = new Foam::surfaceSymmTensorField(Foam::fvc::snGrad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
        ...
        | TOKEN_FYID                               { $$=driver.getField<Foam::surfaceSymmTensorField>(*$1);  delete $1; }
//        | TOKEN_ddt '(' TOKEN_FYID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::surfaceSymmTensorField>(*$3,true,true)() ).ptr();  delete $3; }// no fvc::ddt for surface Fields
        | TOKEN_oldTime '(' TOKEN_FYID ')'	   { $$ = new Foam::surfaceSymmTensorField( driver.getOrReadField<Foam::surfaceSymmTensorField>(*$3,true,true)->oldTime());  delete $3; }
        | TOKEN_flux '(' fsexp ',' yexp ')'       { $$ = Foam::fvc::flux(*$3,*$5).ptr(); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
;
...
fhexp:   fsphericalTensor                  { $$ = $1; }
        ...
        | TOKEN_inv '(' fhexp ')' 	           {
            ...
            delete $3;  driver.setCalculatedPatches(*$$); }
        | flexp '?' fhexp ':' fhexp                   { sameSize($1,$3); sameSize($1,$5); $$ = driver.doConditional($1,$3,$5,driver.makeConstantField<Foam::surfaceSphericalTensorField>(Foam::sphericalTensor::zero)); delete $1; delete $3; delete $5;   driver.setCalculatedPatches(*$$);}
         | TOKEN_snGrad '(' hexp ')'           { $$ = new Foam::surfaceSphericalTensorField(Foam::fvc::snGrad(*$3)); delete $3; $$->dimensions().reset(Foam::dimless); }
       ...
       | TOKEN_min '(' fhexp ',' fhexp  ')'        { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
        ...
        | TOKEN_FHID                               { $$=driver.getField<Foam::surfaceSphericalTensorField>(*$1);  delete $1; }
//        | TOKEN_ddt '(' TOKEN_FHID ')'		   { $$ = Foam::fvc::ddt( driver.getOrReadField<Foam::surfaceSphericalTensorField>(*$3,true,true)()  delete $3; ).ptr(); } // no fvc::ddt for surface Fields
        | TOKEN_oldTime '(' TOKEN_FHID ')'	   { $$ = new Foam::surfaceSphericalTensorField( driver.getOrReadField<Foam::surfaceSphericalTensorField>(*$3,true,true)->oldTime());  delete $3; }
        | TOKEN_flux '(' fsexp ',' hexp ')'       { $$ = Foam::fvc::flux(*$3,*$5).ptr(); delete $3; delete $5; $$->dimensions().reset(Foam::dimless); }
;
...
psexp:  TOKEN_point '(' scalar ')'           { $$ = driver.makePointConstantField<Foam::pointScalarField>($3); }
        ...
        | evaluatePointScalarFunction restOfFunction
          | TOKEN_PSID                        { $$ = driver.getPointField<Foam::pointScalarField>(*$1);  delete $1; }
          | TOKEN_oldTime '(' TOKEN_PSID ')'		   { $$ = new Foam::pointScalarField( driver.getOrReadPointField<Foam::pointScalarField>(*$3,true,true)->oldTime());  delete $3; }
...
pvexp:  pvector                            { $$ = $1; }
        ...
        | TOKEN_PVID                       { $$ = driver.getPointField<Foam::pointVectorField>(*$1);  delete $1; }
        | TOKEN_oldTime '(' TOKEN_PVID ')'		   { $$ = new Foam::pointVectorField( driver.getOrReadPointField<Foam::pointVectorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
ptexp:   ptensor                  { $$ = $1; }
     ...
     delete $1; delete $3;  driver.setCalculatedPatches(*$$); }
        ...
        | TOKEN_PTID                               { $$=driver.getPointField<Foam::pointTensorField>(*$1);  delete $1; }
        | TOKEN_oldTime '(' TOKEN_PTID ')'	   { $$ = new Foam::pointTensorField( driver.getOrReadPointField<Foam::pointTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
// not working either | pyexp '&' pyexp 	   	          { sameSize($1,$3); $$ = driver.makePointField<Foam::pointSymmTensorField>(($1->internalField() & $3->internalField())()); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
     ...
     delete $1; delete $3;  driver.setCalculatedPatches(*$$); }
        ...
        | TOKEN_sqr '(' pvexp ')'           { $$ = driver.makePointField<Foam::pointSymmTensorField>(Foam::sqr($3->internalField())()); delete $3; }
        ...
        | TOKEN_PYID                               { $$=driver.getPointField<Foam::pointSymmTensorField>(*$1);  delete $1; }
        | TOKEN_oldTime '(' TOKEN_PYID ')'	   { $$ = new Foam::pointSymmTensorField( driver.getOrReadPointField<Foam::pointSymmTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
phexp:   psphericalTensor                  { $$ = $1; }
     ...
     delete $1; delete $3;  driver.setCalculatedPatches(*$$); }
        ...
        | TOKEN_PHID                               { $$=driver.getPointField<Foam::pointSphericalTensorField>(*$1);  delete $1; }
        | TOKEN_oldTime '(' TOKEN_PHID ')'	   { $$ = new Foam::pointSphericalTensorField( driver.getOrReadPointField<Foam::pointSphericalTensorField>(*$3,true,true)->oldTime());  delete $3; }
;
...
plexp: TOKEN_point '(' TOKEN_TRUE ')'  { $$ = driver.makePointConstantField<Foam::pointScalarField>(1); }
    ...
    | TOKEN_pset '(' TOKEN_PSETID ')'    {
        $$ = driver.makePointSetField(*$3);
        delete $3;
      }
    | TOKEN_pzone '(' TOKEN_PZONEID ')'  {
        $$ = driver.makePointZoneField(*$3);
        delete $3;
      }
