...
// TODO        | TOKEN_min '(' psexp ',' psexp  ')'           { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
// TODO        | TOKEN_max '(' psexp ',' psexp  ')'           { $$ = Foam::max(*$3,*$5).ptr(); delete $3; delete $5; }
...
// TODO        | '-' psexp %prec TOKEN_NEG         { $$ = new Foam::pointScalarField(-*$2); delete $2; }
        | '(' psexp ')'		            { $$ = $2; }  
...
// TODO        | pvexp '*' psexp 		   { sameSize($1,$3); $$ = new Foam::pointVectorField(*$1 * *$3); delete $1; delete $3; }
        ...
        | pvexp '-' pvexp 		   { sameSize($1,$3); $$ = new Foam::pointVectorField(*$1 - *$3); delete $1; delete $3;}
// TODO        | '-' pvexp %prec TOKEN_NEG 	   { $$ = new Foam::pointVectorField(-*$2); delete $2; }
        | '(' pvexp ')'		           { $$ = $2; }  
...
// TODO        | TOKEN_min '(' pvexp ',' pvexp  ')'           { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
// TODO        | TOKEN_max '(' pvexp ',' pvexp  ')'           { $$ = Foam::max(*$3,*$5).ptr(); delete $3; delete $5; }
...
// TODO        | pyexp '-' ptexp 	   	          { sameSize($1,$3); $$ = new Foam::pointTensorField(*$1 - *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
// TODO        | phexp '-' ptexp 	   	          { sameSize($1,$3); $$ = new Foam::pointTensorField(*$1 - *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
// TODO        | '-' ptexp %prec TOKEN_NEG 	           { $$ = new Foam::pointTensorField(-*$2); delete $2;  driver.setCalculatedPatches(*$$); } 
        | '(' ptexp ')'		        { $$ = $2; }  
...
// TODO        | TOKEN_min '(' ptexp ',' ptexp  ')'        { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
// TODO        | TOKEN_max '(' ptexp ',' ptexp  ')'        { $$ = Foam::max(*$3,*$5).ptr(); delete $3; delete $5; }
...
// TODO        | '-' pyexp %prec TOKEN_NEG 	           { $$ = new Foam::pointSymmTensorField(-*$2); delete $2;  driver.setCalculatedPatches(*$$); } 
        | '(' pyexp ')'		        { $$ = $2; }  
...
// TODO        | TOKEN_min '(' pyexp ',' pyexp  ')'        { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
// TODO        | TOKEN_max '(' pyexp ',' pyexp  ')'        { $$ = Foam::max(*$3,*$5).ptr(); delete $3; delete $5; }
...
// TODO        | phexp '*' psexp 	   	                  { sameSize($1,$3); $$ = new Foam::pointSphericalTensorField(*$1 * *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
        ...
        | phexp '-' phexp 	   	          { sameSize($1,$3); $$ = new Foam::pointSphericalTensorField(*$1 - *$3); delete $1; delete $3;  driver.setCalculatedPatches(*$$); }  
// TODO        | '-' phexp %prec TOKEN_NEG 	           { $$ = new Foam::pointSphericalTensorField(-*$2); delete $2;  driver.setCalculatedPatches(*$$); } 
        | '(' phexp ')'		        { $$ = $2; }  
...
// TODO       | TOKEN_min '(' phexp ',' phexp  ')'        { $$ = Foam::min(*$3,*$5).ptr(); delete $3; delete $5; }
// TODO        | TOKEN_max '(' phexp ',' phexp  ')'        { $$ = Foam::max(*$3,*$5).ptr(); delete $3; delete $5; }
