...
//////////////////////////////////////////////////////////////////////////////////////////
scalarField *PatchValueExpressionDriver::makeRandomField1(label seed)
{
    scalarField *result=new scalarField(patch_.size());
    ...
    Foam::Random rand1(seed+10000);
    forAll(*result,i) {
        (*result)[i]=rand1.scalar01();
    }
...
scalarField *PatchValueExpressionDriver::makeRandomField2(label seed)
{
    scalarField *result=new scalarField(patch_.size());
    ...
    Foam::Random rand2(seed+30000);
    forAll(*result,i) {
        (*result)[i]=rand2.scalar01();
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////
scalarField *PatchValueExpressionDriver::makeGaussRandomField1(label seed)
{
    scalarField *result=new scalarField(patch_.size());
...
scalarField *PatchValueExpressionDriver::makeGaussRandomField2(label seed)
{
    scalarField *result=new scalarField(patch_.size());
