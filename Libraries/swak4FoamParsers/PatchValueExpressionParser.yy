...
vexp:   vector                  { $$ = $1; }
        ...
        | TOKEN_normal '(' ')'          {
            $$ = driver.makeFaceNormalField();
          }
        | TOKEN_Sf '(' ')'              {
            $$ = driver.makeFaceAreaField();
          }
        | TOKEN_Cn '(' ')'              {
            $$ = driver.makeCellNeighbourField();
          }
        | TOKEN_delta '(' ')'              {
...
// produces a reduce/reduce-conflict with the rule below
	...
	| '(' exp ')'		{ $$ = $2; }
        ...
        | TOKEN_pi {
            $$ = driver.makeField(Foam::constant::mathematical::pi);
          }
        | TOKEN_id '(' ')'                         {
            $$ = driver.makeFaceIdField();
          }
        | TOKEN_dist '(' ')'                       {
            $$ = driver.makeNearDistField();
          }
        | TOKEN_cpu '(' ')'       {
...
hexp:   sphericalTensor                  { $$ = $1; }
	...
	| TOKEN_oldTime '(' TOKEN_HID ')'		{
        ...
        | TOKEN_mappedInternal '(' TOKEN_HID ')' {
            $$=driver.mapField<Foam::sphericalTensor>(*$3,true).ptr(); delete $3;
          }
