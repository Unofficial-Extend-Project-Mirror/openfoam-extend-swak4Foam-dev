...
namespace Foam
{
    ...
    template<>
    const char* NamedEnum<Foam::provokeSignalFunctionObject::possibleSignals,4>::names[]=
    {
        "FPE",
        "SEGV",
        "INT",
    ...
    const NamedEnum<provokeSignalFunctionObject::possibleSignals,4> provokeSignalFunctionObject::possibleSignalsNames_;
