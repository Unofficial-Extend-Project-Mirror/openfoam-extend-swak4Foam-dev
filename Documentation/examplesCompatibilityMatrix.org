...
* The Matrix
  ...
  |-------------------------------------------------------------+------------+------------+------------+------------|
  | DynamicMesh/hectivInletACMI2D                               | \checkmark | \sad       | \checkmark | \sad       |
  | DynamicMesh/rotatingTank2D                                  | \checkmark | \checkmark | \checkmark |            |
  | DynamicMesh/switchedTJunction                               | \checkmark | \sad       | \checkmark | \sad       |
  | DynamicMesh/switchedInletACMI2D                             | \checkmark | \sad       | \checkmark | \sad       |
