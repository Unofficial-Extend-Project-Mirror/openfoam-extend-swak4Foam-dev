...
* The Matrix
  ...
  |-------------------------------------------------------------+------------+------------+------------+------------|
  | DynamicMesh/hectivInletACMI2D                               | \checkmark | \sad       |            | \sad       |
  | DynamicMesh/rotatingTank2D                                  | \checkmark | \checkmark |            |            |
  | DynamicMesh/switchedTJunction                               | \checkmark | \sad       |            | \sad       |
  | DynamicMesh/switchedInletACMI2D                             | \checkmark | \sad       |            | \sad       |
  | FiniteArea/planeTransport                                   | \dagger    | \checkmark | \dagger    | \dagger    |
  | FvOptions/angledDuctWithSources                             | \sad       | \dagger    | \sad       | \checkmark |
  | FvOptions/heatExchangerSources                              |            | \dagger    | \checkmark |            |
  ...
  | groovyBC/fillingTheDam                                      | \checkmark | \sad       | \sad       | \checkmark |
  | groovyBC/movingConeDistorted                                | \checkmark | \sad       | \sad       | \checkmark |
  | groovyBC/pulsedPitzDaily                                    | \checkmark | \checkmark | \checkmark | \checkmark |
  | groovyBC/wobbler                                            | \checkmark | \checkmark | \checkmark | \checkmark |
  | Lagrangian/functionObject/angledDuctWithBalls               | \checkmark | \checkmark | \sad       | \checkmark |
  | Lagrangian/functionObject/icoFoamCavityWithParcel           | \checkmark | \checkmark | \sad       | \checkmark |
  | Lagrangian/functionObject/hotStream                         | \sad       |            | \sad       | \sad       |
  ...
  | manipulateFvSolutionFvSchemes/pitzDailyStateMachineSwitched | \checkmark |            | \checkmark |            |
  | manipulateFvSolutionFvSchemes/pitzDailyTimeSwitched         | \checkmark |            | \checkmark |            |
  | other/capillaryRise                                         | \checkmark |            | \checkmark |            |
  | other/counterFlowFlame2DInitialized                         |            |            | \checkmark |            |
  | other/simpleBendedPipe                                      | \checkmark |            | \checkmark |            |
  | other/topoSetDamBreak                                       | \checkmark |            | \checkmark |            |
