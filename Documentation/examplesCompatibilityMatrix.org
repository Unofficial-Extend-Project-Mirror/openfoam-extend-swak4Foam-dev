...
* The Matrix
  | Case name                                                   | 4.1 Fnd    | 4.0 Ext    | 1706+      | 2.3        |
  |-------------------------------------------------------------+------------+------------+------------+------------|
  ...
  | DynamicMesh/switchedTJunction                               | \checkmark | \dagger    | \sad       | \sad       |
  ...
  | Lagrangian/parser/simplifiedSiwek                           | \checkmark | \sad       | \sad       | \checkmark |
  ...
  | tests/testFOExecution                                       |            |            | \checkmark |            |
