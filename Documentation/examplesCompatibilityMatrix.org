...
* The Matrix
  ...
  | manipulateFvSolutionFvSchemes/pitzDailyStateMachineSwitched | \checkmark |            |            |            |
  | manipulateFvSolutionFvSchemes/pitzDailyTimeSwitched         | \checkmark |            |            |            |
  | other/capillaryRise                                         | \checkmark |            |            |            |
  | other/simpleBendedPipe                                      | \checkmark |            |            |            |
  | other/topoSetDamBreak                                       | \checkmark |            |            |            |
