...
* The Matrix
  | Case name                                                   | 7 Fnd      | 4.1 Ext    |       2006 | 2.3        |
  |-------------------------------------------------------------+------------+------------+------------+------------|
  ...
  | DynamicMesh/switchedTJunction                               | \checkmark | \dagger    |            | \sad       |
  ...
  | Lagrangian/functionObjects/hotStream                        | \sad       | \checkmark |            | \sad       |
  ...
  | Lagrangian/LanguageIntegration/angledDuctWithPython2Inject  | \sad       | \checkmark |            | \sad       |
  | Lagrangian/LanguageIntegration/angledDuctWithPython3Inject  | \sad       | \checkmark |            | \sad       |
  ...
  | MakeAxialMesh/axialPitzDaily                                | \checkmark | \sad       |            | \sad       |
  ...
  | other/counterFlowFlame2DInitialized                         | \checkmark | \partial   |            | \checkmark |
  ...
  | Python3Integration/python3ScriptedBCAngledDuct              | \sad       | \checkmark |            | \checkmark |
  | runTimeCondition/simpleSwakCar                              | \dagger    | \dagger    |            | \dagger    |
  ...
  | tests/AMIPipe                                               |            |            |            |            |
  | tests/delayedMappingChannels                                |            | \sad       |            | \checkmark |
  | tests/languageIntegration/luaIntegration                    | \checkmark | \checkmark |            | \checkmark |
  | tests/languageIntegration/pythonIntegration                 | \sad       | \checkmark |            | \checkmark |
  | tests/languageIntegration/python3Integration                | \sad       | \checkmark |            | \checkmark |
  | tests/mappingChannels                                       |            | \sad       |            | \checkmark |
  | tests/mappingChannelsNonUniform                             |            | \sad       |            | \checkmark |
  ...
  | tests/swakDataEntry/flowRateAngledDuct                      |            | \dagger    |            | \sad       |
