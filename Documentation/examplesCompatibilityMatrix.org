...
* The Matrix
  ...
  | Lagrangian/LanguageIntegration/angledDuctWithPython3Inject  | \sad       | \checkmark | \sect      | \sad       |
  ...
  | Python3Integration/python3ScriptedBCAngledDuct              | \sad       | \checkmark | \sect      | \checkmark |
  | SimpleSurface/littleVolcano                                 | \checkmark | \checkmark | \sad       | \checkmark |
  ...
  | tests/languageIntegration/python3Integration                | \sad       | \checkmark | \sad       | \checkmark |
  | tests/SearchableSurfaces/objectTests                        | \checkmark | \checkmark | \checkmark | \checkmark |
