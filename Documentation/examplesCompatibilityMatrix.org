...
* The Matrix
  ...
  | functionPlugins/chemPluginCounterFlowFlame2D                | \checkmark | \sad       | \checkmark |            |
  | functionPlugins/shiftCavity                                 | \checkmark | \sad       | \checkmark |            |
  ...
  | groovyBC/jumpChannel                                        |            |            | \checkmark | \checkmark |
  ...
  | Lagrangian/LanguageIntegration/angledDuctWithLuaInject      | \checkmark | \checkmark | \checkmark |            |
  | Lagrangian/LanguageIntegration/angledDuctWithPython2Inject  | \checkmark | \checkmark | \checkmark |            |
  | Lagrangian/LanguageIntegration/angledDuctWithPython3Inject  | \checkmark | \checkmark |            |            |
  ...
  | other/angledDuctImplicit                                    | \checkmark |            | \checkmark |            |
  | other/capillaryRise                                         | \checkmark | \sad       | \checkmark | \checkmark |
  | other/counterFlowFlame2DInitialized                         | \partial   | \sad       | \partial   | \checkmark |
  ...
  | SimpleSurface/littleVolcano                                 | \sad       |            | \checkmark |            |
  ...
  | tests/SearchableSurfaces/operationsTest                     |            |            |            |            |
  | tests/SearchableSurfaces/operationsTestRotated              |            |            |            |            |
