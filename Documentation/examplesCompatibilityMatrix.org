...
* The Matrix
  ...
  | groovyBC/nonBreakingDam                                     |            |            | \checkmark | \dagger    |
  ...
  | MakeAxialMesh/axialPitzDaily                                | \checkmark |            | \checkmark | \sad       |
  ...
  | tests/delayedMappingChannels                                |            |            | \checkmark | \checkmark |
  ...
  | tests/mappingChannels                                       |            |            | \checkmark | \checkmark |
  | tests/mappingChannelsNonUniform                             |            |            | \checkmark | \checkmark |
  ...
  | tests/swakDataEntry/flowRateAngledDuct                      |            |            | \checkmark | \sad       |
