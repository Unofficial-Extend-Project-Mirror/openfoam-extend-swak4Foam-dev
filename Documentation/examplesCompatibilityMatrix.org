...
* The Matrix
  ...
  | Lagrangian/parser/simplifiedSiwek                 | \checkmark |            |            |            |
  | Lagrangian/parser/parcelInBoxWithExpressions      | \checkmark |            |            |            |
  | Lagrangian/functionObject/angledDuctWithBalls     | \checkmark |            |            |            |
  | Lagrangian/functionObject/hotStream               | \sad       |            |            |            |
  | Lagrangian/functionObject/icoFoamCavityWithParcel | \checkmark |            |            |            |
